...
const edwin = () => {
  ...
  const phoneNumber = '+254 110987656'; // Replace with your desired phone number
  ...
  const handleMapNavigation = () => {
    const latitude = '1.15297';
    const longitude = '35.729516';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/wozaa.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Edwin</Text>
