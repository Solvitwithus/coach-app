...
const Kibet = () => {
  ...
  const phoneNumber = '+254 111028300'; // Replace with your desired phone number
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Kibet</Text>
