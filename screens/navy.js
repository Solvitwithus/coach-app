...
const Navy = () => {
  ...
  const phoneNumber = '+254 111088392'; // Replace with your desired phone number
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/nav.jpg')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Navy</Text>
