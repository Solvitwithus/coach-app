...
const Austine = () => {
  ...
  const phoneNumber = '+254 789675453';
  ...
  const handleMapNavigation = () => {
    const latitude = '1.05297';
    const longitude = '35.828516';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/kim.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Austine</Text>
