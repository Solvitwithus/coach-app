  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/alice.jpg')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Alice</Text>
