...
const Janice = () => {
  ...
  const phoneNumber = '+254 11001168'; 
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/sel.jpg')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Janice</Text>
