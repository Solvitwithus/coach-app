...
const banice = () => {
  ...
  const phoneNumber = '+254 756445434'; 
  ...
  const handleMapNavigation = () => {
    const latitude = '12.05297';
    const longitude = '33.728516';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/kimaa.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Banice</Text>
