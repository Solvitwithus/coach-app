  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        style={[
          styles.innercont,
          item.id === '6' ? styles.selectedInnerCont : null,
        ]}
        key={item.id}
      >
      ...
      <Text style={styles.text}>Sunday Appointment</Text>
      <View>
...
<Text style={{color:'#333333',fontWeight:'bold' , fontSize:25,paddingTop:20}}>1300 hrs ~ 1800 hrs</Text>
      </View>
