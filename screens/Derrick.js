...
const derrick = () => {
  ...
  const phoneNumber = '+254 776544342'; 
  ...
  const handleMapNavigation = () => {
    const latitude = '1.45297';
    const longitude = '35.728518';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/don.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Derrick</Text>
