...
const Nzioki = () => {
  ...
  const phoneNumber = '+254 11031168'; 
  ...
  const handleMapNavigation = () => {
    const latitude = '6.95297';
    const longitude = '30.928516';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/aa.jpg')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Nzioki</Text>
