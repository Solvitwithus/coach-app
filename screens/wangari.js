...
const Wangari = () => {
  ...
  const phoneNumber = '+254 111028366'; // Replace with your desired phone number
  ...
  const handleMapNavigation = () => {
    const latitude = '0.15297';
    const longitude = '35.728516';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/ivy.jpg')} style={styles.image} />
        <View style={styles.textContainer}>
          <Text style={styles.header}>Football Trainer</Text>
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Wangari</Text>
