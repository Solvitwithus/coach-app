...
const lorn = () => {
  ...
  const phoneNumber = '+254 76736568'; 
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/onyango.jpg')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Lorn</Text>
