...
const baxtone = () => {
  ...
  const phoneNumber = '+254 776545675';
  ...
  const handleMapNavigation = () => {
    const latitude = '0.05397';
    const longitude = '34.728516';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/kima.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Baxtone</Text>
