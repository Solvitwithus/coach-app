...
const joel = () => {
  ...
  const phoneNumber = '+254 745676455'; 
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/zin.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Joel</Text>
