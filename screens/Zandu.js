...
const zandu = () => {
  ...
  const phoneNumber = '+254 746453345'; // Replace with your desired phone number
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profile}>
        <Image source={require('./Assets/zan.png')} style={styles.image} />
      ...
      <Text style ={{color:'#222222',fontSize:16,marginLeft:5,marginTop:10}}>Trainer Zandu</Text>
